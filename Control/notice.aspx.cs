...
public partial class Admin_AutoFill : System.Web.UI.Page
{
    ...
    public void generatenoc(string cid, string amount, string name, string temppath)
    {
        ...
        using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
        {
            ...
            phrase = new Phrase("\n\n                                   RAPID JOBS\n", font3);
            document.Add(phrase);
            phrase = new Phrase("                405, RAJ WORLD KANAKNIDHI COMPLEX, OPPOSITE GANDHI SMRUTI BHAVAN, NANPURA, SURAT, GUJARAT 395001\n\n                                                       NO OBJECTION CERTIFICATE\n\n\n", font2);
            document.Add(phrase);

            phrase = new Phrase(new Chunk("Dear ", font1));
            phrase.Add(new Chunk(name + ",\n\n\n", font1));
            phrase.Add(new Chunk("This is no objection from RAPID JOBS regarding the project provided by company, as per the agreement clauses you were liable to pay the penalty amount.\n\n\n", font1));
            phrase.Add(new Chunk("The company has received penalty amount of Rs. ", font1));
            phrase.Add(new Chunk(amount, font1));
            phrase.Add(new Chunk("/- and hence your case has been closed and no further action from RAPID JOBS would be taken against you.\n\n\n", font1));
            ...
            phrase = new Phrase();
            phrase.Add(new Chunk("RAPID JOBS", font1));
            document.Add(phrase);
