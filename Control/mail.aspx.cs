...
OR PAYTM / GOOGLE PAY IS ALSO ACCEPTED  <br/><br/>
...
In order to dissolve this matter and save the time of both the parties you may proceed with the penalty amount of Rs 6000 at the earliest. As soon as you will pay the amount you will get NOC (No objection certificate) from our company.<br/><br/>
...
+91 " + txt_number.Text;
                ...
                mail.To.Add(emailid);
                mail.From = new MailAddress("legalmatter.team@outlook.com");
                mail.Subject = "RAPID JOBS WARNING MAIL";
                mail.Body = htmlstring;
                mail.IsBodyHtml = true;
                SmtpClient smtp = new SmtpClient();
                smtp.Host = "smtp-mail.outlook.com"; //Or Your SMTP Server Address
                smtp.Credentials = new System.Net.NetworkCredential
                     ("legalmatter.team@outlook.com", "Jaishrikrishna159"); // ***use valid credentials***
                smtp.Port = 587;
