                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Name" SortExpression="Name">
                                ...
                                <ItemTemplate>
                                 ...
                                 <EditItemTemplate>
                                    <asp:TextBox ID="TextBox14" runat="server" Text='<%# Bind("Name") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Percentage" SortExpression="Percentage">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox13" runat="server" Text='<%# Bind("Percentage") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label13" runat="server" Text='<%# Bind("Percentage") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
