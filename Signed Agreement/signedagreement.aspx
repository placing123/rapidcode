<%@ Page Language="C#" MasterPageFile="~/Signed Agreement/AdminMaster.master" AutoEventWireup="true"
    CodeFile="signedagreement.aspx.cs" Inherits="Admin_ClientRegistration" Title="Client Registration" %>
                ...
                <td>
                    <asp:GridView ID="grd_client_active" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="btn_active" runat="server" OnClick="btn_active_Click" PostBackUrl='<%# Eval("Cid" ,"signedagreement.aspx?Cid={0}") %>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="PlanId" SortExpression="PlanId">
                             ...
                             <asp:TemplateField HeaderText="Resend">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtn_resendagreement" runat="server" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CommandName="resendagreement"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
