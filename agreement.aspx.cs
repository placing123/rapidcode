...
public partial class agreement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //http://docs.google.com/gview?url=http://rapidjobs.ga/Control/Agreement/12154RPJ18092018.pdf&embedded=true
            HtmlControl contentPanel1 = (HtmlControl)this.FindControl("pdfiframe");
            if (contentPanel1 != null)
                contentPanel1.Attributes["src"] = "http://docs.google.com/gview?url=http://rapidjobswork.com/Control/Agreement/" + Session["Cus_Username"].ToString() + ".pdf&embedded=true";
        }
    }
    protected void btn_tnc_Click(object sender, EventArgs e)
    {
        ...
        string filePath = string.Format("~/sign/{0}.png", Session["Cus_Username"].ToString());
